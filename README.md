<p align="center">
  <img alt="TOBi" src="docs/assets/wordmark-logo-dark.png#gh-dark-mode-only">
  <img alt="TOBi" src="docs/assets/wordmark-logo.png#gh-light-mode-only">
</p>
...
<p align="center">
  ...
  |
  <a href="https://ibm.github.io/ibmi-tobi/">Documentation</a>
</p>
...
* 🌟 **Ease of use.**  Invoking a build of an entire codebase is done with just a single command.  Or, if the *IBM Project Explorer* VS Code extension is installed, a single button click.
