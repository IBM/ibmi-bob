...
This PDF walks through the precursors to TOBi and their pros and cons and how we arrived at the current solution: <a href="https://github.com/IBM/ibmi-bob/blob/master/docs/assets/BobOverview.pdf">Download PDF</a>