...
9. Use [publish github action](https://github.com/IBM/ibmi-bob/actions/workflows/publish_rpm.yml) to generate the `tobi.spec` and create a pull request on [rpm-specs repo](https://github.ibm.com/ibmi-oss/rpm-specs/).  Once the reviewer merges the `yum install tobi` will work.
